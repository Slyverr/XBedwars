package com.slyvr.bedwars.v1_11_R1.utils;
...
import com.slyvr.bedwars.v1_11_R1.entity.BedBug;
import com.slyvr.bedwars.v1_11_R1.entity.BodyGuard;
import com.slyvr.bedwars.v1_11_R1.npc.Villager;
...
public final class BedwarsUtils implements BedwarsPluginUtils {
    ...
    public void register() {
        BedwarsUtils.registerEntity("BedBug", 60, BedBug.class);
        BedwarsUtils.registerEntity("BodyGuard", 99, BodyGuard.class);
        BedwarsUtils.registerEntity("Villager", 120, Villager.class);
    }
