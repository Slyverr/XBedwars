...
public class OfflineBedwarsUser extends Configuration implements OfflineUser {
    ...
    public OfflineBedwarsUser(@NotNull OfflinePlayer owner) {
        super(new File(XBedwars.getInstance().getDataFolder() + "/Users", owner.getUniqueId() + ".yml"));
    ...
    public void loadData() {
        if (XBedwars.isUserDataPersistent()) {
            Database database = XBedwars.getInstance().getDatabase();
    ...
    public void saveData() {
        if (XBedwars.isUserDataPersistent() && XBedwars.getInstance().getDatabase().saveUser(this))
            return;
    ...
    private void loadUserProgress() {
        ...
        this.prestige = UserPrestige.getByName(progress.getString("Prestige"), XBedwars.getInstance().getDefaultPrestige());
