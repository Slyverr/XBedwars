...
public class Configuration {
    ...
    public Configuration(@NotNull File file) {
        ...
        if (file.exists() && !file.isFile())
            XBedwars.getBedwarsLogger().log(Level.SEVERE, "Configuration's file cannot be a folder! (" + file.getName() + ")");
    ...
    public Configuration(@NotNull String resource) {
        ...
        this.file = new File(XBedwars.getInstance().getDataFolder(), resource);
        if (!file.exists())
