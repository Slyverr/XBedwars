...
public final class ScoreboardsConfig extends Configuration {
    ...
    static {
        String yellow_xbedwars = ChatUtils.bold("BED WARS", ChatColor.YELLOW);
        String white_xbedwars = ChatUtils.bold("BED WARS", ChatColor.WHITE);

        List<String> titles = Arrays.asList(
                white_xbedwars, white_xbedwars,
                white_xbedwars, white_xbedwars,
                white_xbedwars, white_xbedwars,
                white_xbedwars, white_xbedwars,
                white_xbedwars, white_xbedwars,
                ...
                white_xbedwars, white_xbedwars,
                yellow_xbedwars, yellow_xbedwars,
                white_xbedwars, white_xbedwars,
                yellow_xbedwars, yellow_xbedwars
        );
    ...
    private void setDefaultResource() {
        InputStream stream = XBedwars.getInstance().getResource("Scoreboards.yml");
        if (stream == null)
            return;
