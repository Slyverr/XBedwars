package com.slyvr.xbedwars.v1_12_R1.entity;
...
import com.slyvr.xbedwars.v1_12_R1.entity.ai.PathfinderGoalLookAtNearbyGamePlayer;
import com.slyvr.xbedwars.v1_12_R1.entity.ai.PathfinderGoalNearestAttackableEnemy;
...
public final class BodyGuard extends EntityIronGolem implements GameEntity {
    ...
    public static final GameEntityType<?> BODY_GUARD_TYPE = new GameEntityType<BodyGuard>("Body Guard", SpawnType.SPAWN_EGG) {
        ...
        public @Nullable BodyGuard getEntity(@NotNull Entity entity) {
            ...
            net.minecraft.server.v1_12_R1.Entity nms_entity = ((CraftEntity) entity).getHandle();
