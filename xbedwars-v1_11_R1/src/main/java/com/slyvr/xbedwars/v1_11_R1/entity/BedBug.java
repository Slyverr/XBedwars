package com.slyvr.xbedwars.v1_11_R1.entity;
...
import com.slyvr.xbedwars.v1_11_R1.entity.ai.PathfinderGoalLookAtNearbyGamePlayer;
import com.slyvr.xbedwars.v1_11_R1.entity.ai.PathfinderGoalNearestAttackableEnemy;
...
public final class BedBug extends EntitySilverfish implements GameEntity {
    ...
    public static final GameEntityType<?> BED_BUG_TYPE = new GameEntityType<BedBug>("Bed Bug", SpawnType.PROJECTILE) {
        ...
        public @Nullable BedBug getEntity(@NotNull Entity entity) {
            ...
            net.minecraft.server.v1_11_R1.Entity nms_entity = ((CraftEntity) entity).getHandle();
