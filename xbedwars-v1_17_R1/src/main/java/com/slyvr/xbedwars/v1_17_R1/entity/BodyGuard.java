package com.slyvr.xbedwars.v1_17_R1.entity;
...
import com.slyvr.xbedwars.v1_17_R1.entity.ai.LookAtNearbyGamePlayerGoal;
import com.slyvr.xbedwars.v1_17_R1.entity.ai.NearestAttackableEnemyGoal;
...
public final class BodyGuard extends IronGolem implements GameEntity {
    ...
    public @NotNull Entity spawn() {
        ...
        this.resetHealth();
        return !(dead = !level.addEntity(this, SpawnReason.CUSTOM)) ? getBukkitEntity() : null;
    }
